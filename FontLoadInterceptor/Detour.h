...
namespace sfh
{
	namespace Detour
	{
		...
		namespace Original
		{
			extern decltype(::CreateFontA)* CreateFontA;
			extern decltype(::CreateFontW)* CreateFontW;

			extern decltype(::CreateFontIndirectA)* CreateFontIndirectA;
			extern decltype(::CreateFontIndirectW)* CreateFontIndirectW;

			extern decltype(::CreateFontIndirectExA)* CreateFontIndirectExA;
			extern decltype(::CreateFontIndirectExW)* CreateFontIndirectExW;

			extern decltype(::EnumFontFamiliesA)* EnumFontFamiliesA;
			extern decltype(::EnumFontFamiliesW)* EnumFontFamiliesW;

			extern decltype(::EnumFontFamiliesExA)* EnumFontFamiliesExA;
			extern decltype(::EnumFontFamiliesExW)* EnumFontFamiliesExW;
		}
	}
}
